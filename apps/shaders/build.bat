...
shaderc -f hello.vs -o ./../vk/hello.vs.bin --varyingdef hello_varying.def --type v --platform windows --profile spirv
shaderc -f hello.fs -o ./../vk/hello.fs.bin --varyingdef hello_varying.def --type f --platform windows --profile spirv
